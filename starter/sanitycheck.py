...
def run_sanity_check(test_dir):
    ...
    if not test_functions_for_post:
        ...
        if len(test_functions_for_post) == 1:
            ...
            print(FAIL_COLOR + "Only one test case was detected \
                for the POST() method.")
            print(FAIL_COLOR + "Please make sure you \
                have two test cases for the POST() method." + "\nOne test case \
                for EACH of the possible inferences \
    ...
    print(WARN_COLOR+"This is a heuristic based sanity \
        testing and cannot guarantee the correctness of your code.")
    print(WARN_COLOR+"You should still check your work \
